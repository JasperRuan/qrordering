                ...
                <table class="table table-bordered table-responsive-md table-striped text-center">
                            ...
                            <td class="pt-3-half" >
                                <div class="content">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">猪肉</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="#">牛肉</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="#">粤菜</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="#">川菜</a>
                                    </div>
                                </div>
                            </td>
                            <td class="pt-3-half" >
                                <div class="content">
                                    <span style="color: #265CBF;margin-right:3px">$</span><input type="text" value="30" style="width:80px">
                    ...
                    <tr class="hide">
                        ...
                        <td>
                                ...
                                <span class="table-remove"><button type="button"
                                    class="btn btn-danger btn-rounded btn-sm my-0" style="margin-bottom:5px !important">删除产品</button></span><br>
                                    ...
                                    <div class="catag">
                                        <div class="head">
                                           ...
                                           <div class="dropdown show">
                                                <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding-left: 30px;padding-right: 30px;  background-color:#265CBF">
                                                   粤菜
                                                </a>

                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <a class="dropdown-item" href="#">闽菜</a>
                                                    <a class="dropdown-item" href="#">川菜</a>
                                                    <a class="dropdown-item" href="#">粤菜</a>
                                                </div>
                                            </div>
